            ...
            <div className="flex items-center justify-center h-fit  m-[20px] ">
                ...
                <div className=" text-xl  bg-white shadow-lg rounded-lg p-8 w-full max-w-md">
                    ...
                    <div className="mb-4">
                        ...
                        <input value={reply} onChange={(e) => setReply(e.target.value)} className="block w-full px-4 py-2 text-gray-700 bg-white border border-gray-300 rounded-md focus:border-blue-500 focus:outline-none"/>
                    </div>
