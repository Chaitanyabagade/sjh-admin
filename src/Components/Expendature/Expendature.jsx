...
useEffect(()=>{
 ...
 <div className='add-deposite text-4xl border-[5px] border-gray-800'>
              <h1 className='text-4xl font-bold text-orange-600 items-center' >Add Expendature</h1>
              ...
              <button className='text-3xl  button text-4xl bg-blue-600 rounded-full w-[32%] ml-[34%] m-5' onClick={handleAddExpendature}>Add</button>
        </div>

        <h2 className='mt-9 text-3xl text-center w-[300px] rounded-full bg-orange-600 p-2 ml-auto mr-auto'> All Users Expendatures Table </h2>
